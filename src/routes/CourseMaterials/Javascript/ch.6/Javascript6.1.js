...
const StringBasics = () => {
	...
	const setProgress = async () => {
		...
		if (currentUser) {
			...
			if (!data.Javascript['6:1']) {
				await updateDoc(progressRef, {
					'Javascript.6:1': 'complete',
		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/javascript/6.2' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>Accessing a character in string</p>

				<p className='font-mono my-8'>
					In JavaScript, you can access individual characters of a string using
					square brackets [] along with an index that represents the position of
					the character you want to retrieve. The indexing starts at 0 for the
					first character in the string. Here's how you can access a character
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Write a JavaScript program that displays the first character of your
						name.
					</p>
				...
				<p className='font-mono my-8'>String concatenation</p>

				<p className='font-mono my-8'>
					String concatenation is the process of combining (joining) two or more
					strings together to create a new string. In JavaScript, you can
					concatenate strings using various methods and operators. The most
					common way to perform string concatenation is:
					<br></br> - Using the + Operator:
					<br></br>You can use the + operator to concatenate strings in
					JavaScript. When the + operator is applied to strings, it joins them
					together into a new string.
				</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create a program that combines your first and last name and displays
						a message that says, "Hello, [full name]!" using string
						concatenation.
					</p>
				...
				<p className='font-mono my-8'>Template literals (Template strings)</p>

				<p className='font-mono my-8'>
					In modern JavaScript, you can use template literals, enclosed in
					backticks (`), to concatenate strings and include variables or
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Write a program that uses a template literal to display your name
						and age in a format like, "Hello, [your name]! You are [your age]
						years old."
					</p>
