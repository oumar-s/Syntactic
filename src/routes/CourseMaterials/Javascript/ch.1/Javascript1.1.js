	...
	const handleRun1 = async () => {
		...
		const response = await openai.chat.completions.create({
			messages: [
				{
					role: 'assistant',
					content: `Evaluate the javascript code below and return only the output. If there a syntax error, return "Syntax error." If there is no valid output, return nothing. ${code1}`,
				},
			],
			model: 'gpt-3.5-turbo',
			max_tokens: 100,
	...
	const handleRun2 = async () => {
		...
		const response = await openai.chat.completions.create({
			messages: [
				{
					role: 'assistant',
					content: `Evaluate the javascript code below and return only the output. If there a syntax error, return "Syntax error." If there is no valid output, return nothing. ${code2}`,
				},
			],
			model: 'gpt-3.5-turbo',
			max_tokens: 100,
	...
	const handleRun3 = async () => {
		...
		const response = await openai.chat.completions.create({
			messages: [
				{
					role: 'assistant',
					content: `Evaluate the javascript code below and return only the output. If there a syntax error, return "Syntax error." If there is no valid output, return nothing. ${code3}`,
				},
			],
			model: 'gpt-3.5-turbo',
			max_tokens: 100,
		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/javascript/1.2' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					In the world of programming, logging is a fundamental practice that
					allows developers to gain insights into the behavior and execution of
					their code. JavaScript, as a versatile and widely-used language for
					both front-end and back-end development, provides developers with
					robust tools for logging and debugging. Logging outputs in JavaScript
					is a crucial part of the development process, enabling developers to
					examine the flow of their applications, identify issues, and trace the
					values of variables during runtime.
				</p>

				<p className='font-mono my-8'>
					Logging in JavaScript involves the use of various techniques and tools
					to record information, such as messages, errors, and variable values,
					to a designated console or log file. This information helps developers
					understand how their code is executing and is instrumental in
					identifying and diagnosing issues, making it an indispensable tool in
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 1: Displaying an Alert{' '}
					</h2>
					<p className='font-mono my-4'>
						Write a simple JavaScript script to display an alert message
				...
				<p className='font-mono my-8'>
					We can output a message to the web console using the console.log
					method:
				</p>
				<div className='editor-container'>
					<Editor
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 2: Outputting to the web console{' '}
					</h2>
					<p className='font-mono my-4'>
						Write a simple JavaScript script to output your first and last to
						the web console.
					</p>
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 3: Displaying an error message{' '}
					</h2>
					<p className='font-mono my-4'>
