const Chapter1 = {
    topic1: {
        ...
        practice1: 'Write a simple JavaScript script to display an alert message “Welcome to my website.”',

        example2: 'console.log("Hello, World!");',
        practice2: 'Write a simple JavaScript script to output your first and last to the web console.',
        
        example3: 'error("There was an error!");',
        practice3: 'Write a simple JavaScript script to display an error on the screen.'
    },
    topic2: {
        example1: 
`let num = 42;            // A number
