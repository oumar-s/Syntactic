...
<br></br>if Statements: Learn how to use ‘if’ statements to execute a block of code if a specified condition is true.
<br></br>else Statements: Explore ‘else’ statements, which allow you to provide an alternative code block to execute if the condition in the ‘if’ statement is false.
                </p>
