...
const setProgress = async () => {
	...
	if (currentUser) {
		...
		if (!data.Javascript['2:2']) {
			await updateDoc(progressRef, {
				'Javascript.2:2': 'complete',
		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/javascript/2.3' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					In this section, we'll explore switch statements, a powerful tool for
					handling multi-way decision-making in JavaScript. Unlike if and else
					statements, which are used for binary decisions, switch statements
					allow you to evaluate a single expression against multiple possible
					values. Let's dive into this versatile feature.
				</p>

				<p className='font-mono my-8'>
					Switch statements are used when you have a single expression (often a
					variable) that you want to compare against multiple possible values.
					They provide a cleaner and more efficient way to handle multiple cases
					than a series of if and else if statements.
				</p>
				...
				<p className='font-mono mb-8'>
					Simple Weekday Selector. In this example a switch statement is used to
					determine a weekday based on a number input.
				</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Implement a switch statement to handle different cases based on user
						input. Prompt the user to enter a day of the week. Use a switch
						statement to display a message corresponding to the entered day.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Use a switch statement to build a simple calculator that performs
						basic operations. Prompt the user to enter two numbers and an
						operator (+, -, *, /). Use a switch statement to perform the
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						In this practice, you'll create a grading system using switch
						statements. Prompt the user to enter a numerical grade (e.g., 85).
						Use a switch statement to determine the corresponding letter grade
						(A, B, C, D, or F) and display it.
					</p>
