...
const ClassConstructor = () => {
	...
	const setProgress = async () => {
		...
		if (currentUser) {
			...
			if (!data.Javascript['8:2']) {
				await updateDoc(progressRef, {
					'Javascript.8:2': 'complete',
		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/javascript/8.3' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					The constructor is a special method in a class that is executed when
					an object is created from that class. It is used to initialize the
					object's properties.
				</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create a class called Animal with a constructor that takes name and
						species as parameters. Initialize properties with these values.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Define a class Product with a constructor that accepts name, price,
						and quantity. Initialize the object with these values.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create a class Rectangle with a constructor that sets width and
						height. Initialize these properties in the constructor.
					</p>
