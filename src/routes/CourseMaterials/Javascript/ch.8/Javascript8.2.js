        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    The constructor is a special method in a class that is executed when an object is created from that class. It is used to initialize the object's properties.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Define a class Product with a constructor that accepts name, price, and quantity. Initialize the object with these values.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create a class Rectangle with a constructor that sets width and height. Initialize these properties in the constructor.
                    </p>
