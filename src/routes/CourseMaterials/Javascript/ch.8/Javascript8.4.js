        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    Private fields in a class are properties that are marked as private and can only be accessed and modified within the class itself.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Define a class `Person` with a private field `ssn` (social security number). Implement a method `getSSN()` to access the `ssn` field.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create a class Book with a private field isbn (International Standard Book Number). Implement a method getISBN() to retrieve the isbn.
                    </p>
