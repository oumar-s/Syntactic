        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    Setters are methods that allow you to set the value of a class property. They are often used to modify private fields.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Define a class Person with a private field email. Implement a setter method setEmail(newEmail) to update the email.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create a class `BankAccount` with a private field `balance`. Implement a setter method setBalance(newBalance) to update the balance.
                    </p>
