        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    Public fields in a class are properties that can be accessed and modified directly from instances of the class.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create a class `Circle` with a public field `radius`. Create an instance of `Circle` and set its `radius` property to a value.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Define a class `Student` with a public field `name`. Create a `Student` object and assign a name to it.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create a class Car with a public field color. Create a Car object and set its color property.
                    </p>
