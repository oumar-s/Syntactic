...
const DeclaringAClass = () => {
	...
	const setProgress = async () => {
		...
		if (currentUser) {
			...
			if (!data.Javascript['8:1']) {
				await updateDoc(progressRef, {
					'Javascript.8:1': 'complete',
		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/javascript/8.2' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					In JavaScript, you can declare a class using the `class` keyword. A
					class serves as a blueprint for creating objects with shared
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create a class called `Person` with properties `name` and `age`. Add
						a method `introduce()` that prints the person's name and age.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						...
						Add a method `startEngine()` that logs "Engine started!".
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create a class `Book` with properties `title` and `author`. Add a
						method `displayInfo()` to display the book's title and author.
					</p>
...
export default DeclaringAClass;
