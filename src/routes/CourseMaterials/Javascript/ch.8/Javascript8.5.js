        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    Getters are methods that allow you to retrieve the value of a class property. They are often used to access private fields.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Define a class Student with a private field grade. Implement a getter method getGrade() to access the grade field.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Define a class Car with a private field speed. Implement a getter method getSpeed() to access the speed field.
                    </p>
