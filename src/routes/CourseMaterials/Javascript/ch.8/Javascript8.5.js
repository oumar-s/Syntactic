...
const Getter = () => {
	...
	const handleSubmit2 = async () => {
		...
		const response = await openai.chat.completions.create({
			messages: [
				{
					role: 'assistant',
					content: `The code bellow is an attempt to solve the given practice problem bellow. Based on this attempt determine if the code correctly solve the practice problem. The output should look like this: First state if the code is "Correct" or "Incorrect". Then give "a constructive feedback that a beginner will find useful based on common coding standards and clean code. if there is no constructive feedback return 'no feedback'. code is ${code2}, practice problem is ${Chapter1.topic5.practice2}`,
				},
			],
			model: 'gpt-3.5-turbo',
			max_tokens: 100,
	...
	const handleSubmit3 = async () => {
		...
		const response = await openai.chat.completions.create({
			messages: [
				{
					role: 'assistant',
					content: `The code bellow is an attempt to solve the given practice problem bellow. Based on this attempt determine if the code correctly solve the practice problem. The output should look like this: First state if the code is "Correct" or "Incorrect". Then give "a constructive feedback that a beginner will find useful based on common coding standards and clean code. if there is no constructive feedback return 'no feedback'. code is ${code3}, practice problem is ${Chapter1.topic5.practice3}`,
				},
			],
			model: 'gpt-3.5-turbo',
			max_tokens: 100,
	...
	const setProgress = async () => {
		...
		if (currentUser) {
			...
			if (!data.Javascript['8:5']) {
				await updateDoc(progressRef, {
					'Javascript.8:5': 'complete',
		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/javascript/8.6' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					Getters are methods that allow you to retrieve the value of a class
					property. They are often used to access private fields.
				</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create a class Circle with a private field radius. Implement a
						getter method getDiameter() that returns the diameter.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Define a class Student with a private field grade. Implement a
						getter method getGrade() to access the grade field.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Define a class Car with a private field speed. Implement a getter
						method getSpeed() to access the speed field.
					</p>
