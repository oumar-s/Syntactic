...
const ThenAndCatch = () => {
	...
	const setProgress = async () => {
		...
		if (currentUser) {
			...
			if (!data.Javascript['9:1']) {
				await updateDoc(progressRef, {
					'Javascript.9:1': 'complete',
		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/javascript/9.2' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					In JavaScript Promises, the `then` and `catch` methods are used for
					handling the result or error of asynchronous operations, respectively.
					`then` is used when a Promise resolves successfully, and `catch` is
					used to handle any errors that occur during the execution of the
					Promise.
				</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Write a Promise that resolves after a random delay (between 1 and 5
						seconds) with the message "Promise resolved."
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create a Promise that rejects with the error message "Promise
						rejected due to an error" after a random delay (between 1 and 5
						seconds).
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Build a function that accepts a number and returns a Promise that
						resolves with the square of the number. Use it to calculate the
						square of 5 and handle the result using `then`.
					</p>
