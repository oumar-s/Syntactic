    ...
    return (
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <br></br>Declaration: Learn how to create arrays and populate them with values.
                <br></br>Accessing Elements: Understand how to access elements within arrays using indices.
                <br></br>Array Methods: Explore built-in array methods for common operations like adding, removing, sorting, and filtering elements.
                ...
                <p className='font-mono mb-8'>
                    In this example, we'll create an array and access its elements using indices.
                </p>
                ...
                <p className='font-mono mb-8'>
                    In this example, we have an array of numbers and we'll use JavaScript array methods to sort them in ascending order.
                </p>
                ...
                <p className='font-mono mb-8'>
                    In this example, we'll demonstrate various JavaScript array methods for adding and removing elements.
                </p>
                ...
                <p className='font-mono mb-8'>
                    In this example, we'll use a for loop to calculate the sum of values in an array.
                </p>
                ...
                <p className='font-mono mb-8'>
                    In this example, we'll use a forEach loop to print each element of an array.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Utilize arrays to store and display a list of items. Create an array containing a list of items (e.g., fruits, movies, cities). Use a loop to display each item in the array.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Write a program that calculates the average of values in an array. Declare an array of numbers (e.g., [10, 15, 20, 25, 30]). Write a function called calculateAverage that takes the array as a parameter. Inside the function, calculate the average of the values in the array. Return the calculated average.
                    </p>
