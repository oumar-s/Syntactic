        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    In this part of the chapter, we'll delve into JavaScript objects, which are versatile data structures that can store both data (properties) and functions (methods). Objects are essential for modeling complex data in JavaScript.
                </p>

                <p className='font-mono my-8'>                
                    Objects in JavaScript consist of key-value pairs, where each key is a property and its associated value can be of various types, including other objects and functions (methods). We'll cover:
                    <br></br>Object Creation: Learn how to create objects using object literals and constructors.
                    <br></br>Properties: Explore how to define and access properties within objects.
                    <br></br>Methods: Understand how to create and use methods within objects for encapsulating functionality.
                </p>
                ...
                <p className='font-mono mb-8'>
                    In this example, we'll create an array of objects to represent books in a library catalog.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create an object representing a person with name and age properties. Assign values to these properties to represent a person's name and age.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create an object called car with properties such as make, model, and isRunning. Define methods within the car object, such as start and stop, to control the car's engine. Implement these methods to change the isRunning property accordingly.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create an object called cartItem with properties such as productName, price, and quantity. Add multiple cartItem objects to an array to represent items in a shopping cart.
                    </p>
