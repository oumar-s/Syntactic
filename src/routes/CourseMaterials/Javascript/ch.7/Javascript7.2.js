        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <h1 className='text-2xl md:text-4xl font-bold my-4 bg-slate-700 p-4'>
                    Setting a Property in an Object
                </h1>

                <p className='font-mono my-8'>
                    Setting a property in an object means assigning a new value to a specific property key within the object or creating a new property if it doesn't exist.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Define an object `product` with a `name` property set to "Laptop" and a `price` property set to 899.99. Update the `price` to 799.99.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create an object `animal` with a `species` property set to "Lion." Add a new property `habitat` and set it to "Savannah."
                    </p>
...
export default SettingPropertyInObject;
