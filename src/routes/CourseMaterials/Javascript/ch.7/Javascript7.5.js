        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    The `Object.keys()` and `Object.values()` methods can be used in combination with the `.forEach()` method to iterate through the keys or values of an object.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Define an object `city` with properties `name`, `population`, and `country`. Use `.forEach()` to display each property and its value.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create an object `book` with properties `title`, `author`, and `genre`. Use `.forEach()` to output each property and its value.
                    </p>
