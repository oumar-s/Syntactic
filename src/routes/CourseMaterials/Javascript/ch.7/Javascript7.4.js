        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    The `Object.values()` method returns an array containing all the values of an object's properties.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Define an object `country` with properties `name`, `population`, and `language`. Use `Object.values()` to retrieve an array of the property values.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create an object `movie` with properties `title`, `director`, and `year`. Get an array of the property values using `Object.values()`.
                    </p>
