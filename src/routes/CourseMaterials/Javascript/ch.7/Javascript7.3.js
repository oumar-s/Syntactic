        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    The `Object.keys()` method returns an array containing all the keys (property names) of an object.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Define an object `city` with properties `name`, `population`, and `country`. Use `Object.keys()` to retrieve an array of the property names.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Create an object `book` with properties `title`, `author`, and `genre`. Get an array of the property names using `Object.keys()`.
                    </p>
