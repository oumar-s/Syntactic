...
const ObjectMethodKeys = () => {
	...
	const setProgress = async () => {
		...
		if (currentUser) {
			...
			if (!data.Javascript['7:3']) {
				await updateDoc(progressRef, {
					'Javascript.7:3': 'complete',
		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/javascript/7.4' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					The `Object.keys()` method returns an array containing all the keys
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						...
						`taste`. Use `Object.keys()` to get an array of the property names.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						...
						`country`. Use `Object.keys()` to retrieve an array of the property
						names.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						...
						`genre`. Get an array of the property names using `Object.keys()`.
					</p>
...
export default ObjectMethodKeys;
