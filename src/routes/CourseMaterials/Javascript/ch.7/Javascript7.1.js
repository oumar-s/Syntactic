...
const AccessingaValueinanObject = () => {
	...
	const setProgress = async () => {
		...
		if (currentUser) {
			...
			if (!data.Javascript['7:1']) {
				await updateDoc(progressRef, {
					'Javascript.7:1': 'complete',
		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/javascript/7.2' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					Accessing a value in an object means retrieving the data associated
					with a specific property key within the object.
				</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create an object called `car` with properties like `make`, `model`,
						and `year`. Access and log the `model` of the car using both dot and
						bracket notation.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Define an object called `student` with properties for `name`, `age`,
						and `grade`. Access and print the `age` of the student using both
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						...
						`yearPublished`. Access and display the `title` using dot notation.
					</p>
...
export default AccessingaValueinanObject;
