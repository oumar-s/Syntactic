        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    In this topic, we'll explore loop control statements, which are powerful tools for altering the flow of loops in JavaScript. Loop control statements allow you to customize the behavior of loops, making them more flexible and efficient. We'll cover two essential loop control statements: break and continue.
                </p>

                <p className='font-mono my-8'>
                Loop control statements are used to modify the standard behavior of loops. They include:
                <br></br>break Statement: The break statement is used to exit a loop prematurely when a specific condition is met. It allows you to terminate the loop and continue with the code outside the loop.
                <br></br>continue Statement: The continue statement is used to skip the current iteration of a loop when a particular condition is satisfied. It allows you to move to the next iteration without executing the remaining code for the current iteration.
                </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Use break statement to exit a loop under certain conditions. Create a loop, such as a for or while loop. Within the loop, include a condition that, when met, triggers the break statement. Test the loop to ensure it exits when the condition is satisfied.
                    </p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='font-mono my-4'>
                        Use the continue statement to skip iterations in a loop. Create a loop, such as a for or while loop. Include a condition that, when met, triggers the continue statement.
                        Test the loop to ensure it skips iterations when the condition is satisfied.
                    </p>
