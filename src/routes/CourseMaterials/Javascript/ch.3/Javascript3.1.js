...
const LoopsBasics = () => {
	...
	const setProgress = async () => {
		...
		if (currentUser) {
			...
			if (!data.Javascript['3:1']) {
				await updateDoc(progressRef, {
					'Javascript.3:1': 'complete',
		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/javascript/3.2' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					Loops are a fundamental and powerful construct in programming that
					allow developers to automate repetitive tasks and execute code
					multiple times. They are the driving force behind efficient data
					processing, iteration, and control flow in programming languages. In
					the world of JavaScript and many other programming languages, loops
					are indispensable tools for building dynamic and responsive
					applications.
				</p>

				<p className='font-mono my-8'>
					Loops are essential when you need to perform a set of instructions
					repeatedly, whether it's processing a large dataset, iterating through
					an array, or executing a sequence of actions based on a condition.
					They provide a structured and systematic way to achieve these tasks
					without the need for writing redundant code.
				</p>
				...
				<p className='font-mono mb-8'>
					Counting with a While Loop. In this example we're using a while loop
				...
				<p className='font-mono mb-8'>
					Iterating with a For Loop. In this example we're using a for loop to
					iterate through an array of colors and print each color.
				</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Write a while loop to print numbers from 1 to 10. Initialize a
						variable called count with a value of 1. Use a while loop to print
						the numbers from count to 10. Increment the count variable within
						the loop.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Iterate through an array and display its elements. Create an array
						containing a list of items (e.g., fruits, cities, names). Use a for
						loop to iterate through the array and display each element.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create a countdown timer using a for loop. Prompt the user to enter
						a countdown value (e.g., 10). Use a for loop to count down from the
						entered value and display each countdown step.
					</p>
