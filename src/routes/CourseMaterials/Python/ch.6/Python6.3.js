        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono mt-8'>
                    You can perform various operations on lists, such as adding elements, removing elements, and checking if an element exists in a list. This is as seen below.
                </p>
                ...
                <p className='font-mono mt-8'>
                    Python provides built-in functions to work with lists, like sorting, finding the length, and copying. For example:
                </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: List Reversal </h2>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: List Filtering</h2>
                    <p className='font-mono my-4'>
                        Create a Python program that filters out even numbers from a list and creates a new list containing only the odd numbers.
                    </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 3: List Sorting</h2>
                    <p className='font-mono my-4'>
                        Design a Python program that takes a list of names and sorts them in alphabetical order. Display the sorted list.
                    </p>
