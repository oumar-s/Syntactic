    ...
    return (
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: List Summation </h2>
                    <p className='font-mono my-4'>
                        Write a Python program that calculates and prints the sum of all numbers in a given list of integers.
                    </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: List Concatenation</h2>
                    <p className='font-mono my-4'>
                        Create a Python program that takes two lists and concatenates them into a single list.
                    </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 3: List Searching</h2>
                    <p className='font-mono my-4'>
                        Design a Python program that asks the user to enter an element and checks if it exists in a predefined list. Display an appropriate message.
                    </p>
