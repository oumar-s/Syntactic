		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/python/6.3' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 1: Finding Maximum{' '}
					</h2>
					<p className='font-mono my-4'>
						Write a Python program that finds and prints the maximum element in
						a list of numbers.
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create a Python program that uses list slicing to extract a sub-list
						from a given list. Prompt the user to enter the start and end
						indices for slicing.
					</p>
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 3: List Iteration
					</h2>
					<p className='font-mono my-4'>
						Design a Python program that iterates through a list of names and
						prints each name in uppercase.
					</p>
