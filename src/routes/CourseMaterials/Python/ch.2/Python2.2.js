        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    User input and output in Python enable interaction with the program's users by allowing them to provide information and receive responses. It's a fundamental feature that facilitates communication and data exchange between the user and the software, enhancing the user experience and enabling dynamic and personalized applications.
                </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: Taking user input and displaying output </h2>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: Multiple Input and Output</h2>
                    <p className='font-mono my-4'>
                        Write a Python program that prompts the user to enter their name, age, and favorite color. After receiving the input, the program should print out the collected information.
                    </p>
