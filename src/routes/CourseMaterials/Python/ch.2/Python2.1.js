		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/python/2.2' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					Variables in Python are symbolic names that represent data stored in
					memory. They are essential elements of any Python program, allowing
					developers to store, manipulate, and work with data of various types,
					such as numbers, text, and complex structures. Variables are
					dynamically typed, meaning their data type is determined automatically
					based on the assigned value, providing flexibility in programming.
					Python variables enable you to create readable, expressive code,
					making it a versatile language for a wide range of applications, from
					simple scripts to complex software development and data analysis
				</p>
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 1: Assigning Values to Variables{' '}
					</h2>
					<p className='font-mono my-4'>
						Write a basic Python script that assigns the variable "language" the
						value of "Python"
					</p>
					...
					<p className='font-mono my-8'>
						This is an example of Multiple Assignments where you can assign
						values to multiple variables in a single line. The value '1' is
						assigned to variable 'a', '2' is assigned to 'b', and '3' is
						assigned to 'c'.
					</p>
					<div className='editor-container'>
						<Editor
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 2: Multiple Assignment
					</h2>
					<p className='font-mono my-4'>
						Write a Python script that assigns the value of '10' to 'x', '20' to
						'y' and '30' to 'z' using multiple assignments.
					</p>
				...
				<p className='font-mono my-8'>
					This is an example of Chained Assignments where you can assign the
					same value to multiple variables in one line. The variables 'x', 'y'
					and 'z' are all assigned a value of '5'.
				</p>
				<div className='editor-container'>
					<Editor
						height='80px'
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 3: Chained Assignment{' '}
					</h2>
					<p className='font-mono my-4'>
						Write a Python script that assigns the value of '99' to 'd', 'e',
						and 'f' using chained assignment.
					</p>
