        ...
        <div className='bg-midnight pt-1'>
            ...
            <div className='flex flex-wrap md:flex-nowrap  font-ubuntu bg-midnight text-white'>
                <div className='w-1/2 h-fit overflow-auto pl-5 pr-5'>
                    ...
                    <p className='font-mono my-8'>
                        In this section, we'll practice working with data types, variables, input and output, and type conversion in Python. These exercises will help you become more proficient in handling data and user interactions.
                    </p>
...
export default PythonExamination2;