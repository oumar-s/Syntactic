...
Floating-Point Numbers (float): Numbers with decimals, such as 3.14 or -0.5. <br></br>
Strings (str): Text, enclosed in single or double quotes, like "Hello" or 'Python'. <br></br>
Booleans (bool): Binary values: True or False. <br></br>
These basic data types are the building blocks for most Python programs. You'll use them for numbers, text, and making decisions in your code.
                </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: User Variables </h2>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: Printing Out Data Types</h2>
                    <p className='font-mono my-4'>
                        Write a Python program that defines variables for the following information about a person: name, age, height (in meters), and whether they are married (True or False). Then, print out the type of each variable.
                    </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 3: Type Conversion</h2>
                    <p className='font-mono my-4'>
                        Write a Python program that collects the user's age as a string input and converts it to an integer for further processing.
                    </p>
