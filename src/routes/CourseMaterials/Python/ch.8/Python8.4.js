        ...
        <div className='bg-midnight pt-1'>
            ...
            <div className='flex flex-wrap md:flex-nowrap  font-ubuntu bg-midnight text-white'>
                <div className='w-1/2 h-fit overflow-auto pl-5 pr-5'>
                    ...
                    <p className='font-mono my-8'>
                        In this section, we'll practice using classes as a fundamental component of Python programming. These exercises will assist you in enhancing your skills in working with classes, from creating and designing them to tackling more advanced tasks like subclassing, inheritance, and organizing data effectively through object-oriented programming. By the end of these practice problems, you'll have a strong grasp of how to create and utilize classes to structure and manage data in your Python programs.
                    </p>
...
export default PythonExamination8;