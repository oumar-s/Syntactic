        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    In this section, we'll cover the fundamental concepts of defining classes, creating objects, and the constructor method.
                </p>
                ...
                <p className='font-mono my-8'>
                    To define a class, you use the class keyword followed by the class name. A class is a blueprint for creating objects. Example:
                </p>
                ...
                <p className='font-mono my-8'>
                    The __init__ method is a special method called the constructor. It initializes object attributes when an instance of the class is created. Parameters can be passed to the constructor. Example:
                </p>
                ...
                <p className='font-mono my-8'>
                    To create an instance of a class, you call the class like a function. This creates an object with the specified attributes. Example:
                </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: Class for Employee Information </h2>
                    <p className='font-mono my-4'>
                        Design a class called Employee to represent information about an employee, including attributes such as employee ID, name, job title, and salary.
                    </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: Class for Animal Characteristics</h2>
                    <p className='font-mono my-4'>
                        Create a class called Animal to represent general information about animals, including attributes like species, habitat, and average lifespan.
                    </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 3: Class for Vehicle Details</h2>
                    <p className='font-mono my-4'>
                        Implement a class called Vehicle to store details about vehicles, including attributes such as make, model, year, and fuel type.
                    </p>
