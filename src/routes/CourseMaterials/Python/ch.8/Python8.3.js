        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    In this section, we'll explore the concept of encapsulation, which involves restricting access to certain parts of an object, and practical applications of classes
                </p>
                ...
                <p className='font-mono my-8'>
                    Encapsulation is the concept of restricting access to certain parts of an object. In Python, you can achieve encapsulation by using private attributes and methods, typically indicated with a double underscore (__).
                </p>
                ...
                <p className='font-mono my-8'>
                    The Circle class uses a private attribute __radius to store the radius of the circle, preventing direct access from outside the class.
                </p>

                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: Book Class </h2>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: Bank Account Class</h2>
                    <p className='font-mono my-4'>
                        Create a class BankAccount with private attributes __balance and __account_number. Implement methods for depositing and withdrawing money from the account, ensuring that the balance is properly encapsulated. Test these methods with various transactions.
                    </p>
                ...
                <p className='font-mono my-8'>
                    Classes are used to model real-world objects and their behavior. They provide a structured way to represent and manipulate data.
                </p>
                ...
                <p className='font-mono my-8'>
                    The Car class represents a car's attributes and has a method to display car information.
                </p>

                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 3: Product Class</h2>
                    <p className='font-mono my-4'>
                        Define a class Product with attributes name, price, and quantity. Implement a method to calculate the total cost of a certain quantity of the product. Create an instance and test the method with different product details.
                    </p>
