		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/python/3.2' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<h1 className='text-2xl md:text-4xl font-bold my-4 bg-slate-700 p-4'>
					Integer and Float Operations in Python
				</h1>
				<p className='font-mono my-8'>
					Python supports various arithmetic operations for both integers and
					floating-point numbers. These operations include addition,
					subtraction, multiplication, division, integer division, modulus,
					exponentiation, and increment/decrement. They allow you to perform a
					wide range of mathematical calculations and manipulations on numeric
					values.
				</p>
				...
				<p className='font-mono mb-8'>
					The operations are demonstrated in the following:
				</p>
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 1: Calculate the Area of a Rectangle{' '}
					</h2>
					<p className='font-mono my-4'>
						Write a Python program that calculates the area of a rectangle.
						Collect the length and width of the rectangle as float inputs and
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 2: Calculate the Average of Three Numbers
					</h2>
					<p className='font-mono my-4'>
						Write a Python program that calculates the average of three numbers.
						Collect three numbers as float inputs and then calculate and display
						their average.
					</p>
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 3: Convert Minutes to Hours and Minutes
					</h2>
					<p className='font-mono my-4'>
						Write a Python program that converts a given number of minutes into
						hours and remaining minutes. Collect the number of minutes as an
						integer input and then calculate and display the equivalent hours
						and minutes.
					</p>
...
export default PythonIntegerOperations;
