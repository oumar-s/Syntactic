        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    Python supports various arithmetic operations for both integers and floating-point numbers. These operations include addition, subtraction, multiplication, division, integer division, modulus, exponentiation, and increment/decrement. They allow you to perform a wide range of mathematical calculations and manipulations on numeric values.
                </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: Calculate the Area of a Rectangle </h2>
                    <p className='font-mono my-4'>
                        Write a Python program that calculates the area of a rectangle. Collect the length and width of the rectangle as float inputs and then calculate and display the area.
                    </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: Calculate the Average of Three Numbers</h2>
                    <p className='font-mono my-4'>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 3: Convert Minutes to Hours and Minutes</h2>
                    <p className='font-mono my-4'>
