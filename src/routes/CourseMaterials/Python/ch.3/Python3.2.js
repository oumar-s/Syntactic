        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    In Python, strings are versatile data types. You can perform a wide range of operations and use methods to manipulate and work with strings effectively. Here's a guide to essential string operations, methods, and practice problems.
                </p>

                <p className='font-mono mb-8'>
                    String Operations <br></br>
                    1. Length of a String <br></br>
                    You can find the length of a string using the len() function. <br></br>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: String Length </h2>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: String Manipulation</h2>
                    <p className='font-mono my-4'>
                        Write a Python program that takes a user-entered string, converts it to lowercase, and removes any leading or trailing spaces.
                    </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 3: Personal Introduction </h2>
                    <p className='font-mono my-4'>
                        Write a Python program that collects a user's name, age, and city. Use string formatting to create a personal introduction message and display it.
                    </p>
