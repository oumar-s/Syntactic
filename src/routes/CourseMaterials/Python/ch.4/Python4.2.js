        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    The else statement works in conjunction with if. It allows you to provide an alternative block of code to execute if the condition in the if statement is False. 
                </p>
                ...
                <p className='font-mono mb-8'>
                    In this example, because the condition age greater than or equal to 18 is False, the code inside the else block is executed.
                </p>

                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1:  Positive or Negative? </h2>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: Maximum of Three Numbers</h2>
                    <p className='font-mono my-4'>
