        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    The Elif (short for "else if") statement is used to check multiple conditions in a series. It follows an if statement and is evaluated if the previous if or elif conditions are False. Here's the syntax:
                </p>
                ...
                <p className='font-mono mb-8'>
                    In this example, the elif statements allow you to define multiple conditions and execute code based on the first condition that is True.
                </p>

                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: Grade Calculator </h2>
...
<br></br>70-79: C
<br></br>60-69: D
<br></br>0-59: F Display the calculated letter grade.
                    </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: Tax Calculator</h2>
                    <p className='font-mono my-4'>
