		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/python/4.2' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono mb-8'>
					In this example, the code inside the if block is executed because the
					condition age greater than or equal to 18 is True.
				</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Write a Python program that asks the user to enter an integer. Use
						an "if" statement to determine if the number is even or odd. Display
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Create a Python program that prompts the user to enter a test score.
						Use an "if" statement to check if the score is equal to or greater
						than 70. If so, display "You passed!" Otherwise, display "You
						failed."
					</p>
