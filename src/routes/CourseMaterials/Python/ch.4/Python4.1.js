    ...
    return (
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono mb-8'>
                    In this example, the code inside the if block is executed because the condition age greater than or equal to 18 is True.
                </p>

                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: Odd or Even? </h2>
                    <p className='font-mono my-4'>
                        Write a Python program that asks the user to enter an integer. Use an "if" statement to determine if the number is even or odd. Display an appropriate message.
                    </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: Pass or Fail?</h2>
                    <p className='font-mono my-4'>
