        ...
        <div className='flex flex-col font-ubuntu bg-midnight text-white'>
            <div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
                ...
                <p className='font-mono my-8'>
                    A "for" loop is a fundamental tool in Python for iterating over sequences like lists, tuples, strings, and more. It allows you to execute a set of statements for each item in the sequence. This guide covers the basics of "for" loops in Python.
                </p>
                ...
                <p className='font-mono mt-8'>
                item is a variable that represents the current item in the sequence.<br></br>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 1: Looping Through Items Type, Iterating Through Items </h2>
                    <p className='font-mono my-4'>
                        Write a Python program that iterates through a list of animals and prints each animal using a "for" loop.
                    </p>
                ...
                <p className='font-mono mt-8'>
                    The range() function is commonly used to generate a sequence of numbers. It's often used with "for" loops to control the number of iterations.
                </p>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 2: Looping Through Ranges</h2>
                    <p className='font-mono my-4'>
                ...
                <p className='font-mono my-4'>
                Python provides loop control statements to modify loop behavior. <br></br>
                ...
                <div className='mt-10'>
                    <h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>Practice 3: Loop Control Statements</h2>
                    <p className='font-mono my-4'>
