		...
		<div className='flex flex-col font-ubuntu bg-midnight text-white'>
			<div className='justify-items-center ml-20 mr-20 pl-20 pr-20'>
				<div className='flex justify-center space-x-8 p-5 m-5'>
					...
					<Link to='/python/1.2' onClick={setProgress}>
						<img
							className='bg-slate-400 hover:bg-gray-300 p-2'
							src={rightArrowIcon}
				...
				<p className='font-mono my-8'>
					In the world of programming, printing is a fundamental practice that
					enables developers to gain insights into the behavior and execution of
					their code. Python, as a versatile and widely-used language for a
					variety of applications, provides developers with powerful tools for
					logging and debugging. Logging outputs in Python is a crucial part of
					the development process, allowing developers to inspect the flow of
					their applications, pinpoint issues, and track variable values during
					runtime.
				</p>
				...
				<div className='mt-10'>
					<h2 className='text-base md:text-xl font-bold bg-slate-700 p-2'>
						Practice 1: Printing "Welcome to my Python journey"{' '}
					</h2>
					<p className='font-mono my-4'>
						Write a basic Python script to display a message saying "Welcome to
						my Python journey".
					</p>
				...
				<div className='mt-10'>
					...
					<p className='font-mono my-4'>
						Write a basic Python script to raise and catch an exception,
